...
document.addEventListener("DOMContentLoaded", function () {
  ...
  soundElements.forEach((selement) => {
    ...
    favoritesound.innerHTML =
      '<img src="/quiz-30.github.io/media/star-regular.svg" id="favoritesound" title="Favorite Sound">';
    ...
    let soundName = selement
      ...
      .getAttribute("src");
    downloads.innerHTML = `<img src="/quiz-30.github.io/media/download.svg" title="Download Sound">`;
    ...
    thing.forEach((game) => {
      ...
      if (item === one) {
        ...
        game
          ...
          .setAttribute("src", "/quiz-30.github.io/media/star-solid.svg");
      }
    });
  });
